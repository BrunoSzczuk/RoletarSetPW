...
def main(): 
    ...
    Quant = int(input("Quantos adds de 6% vc quer?\n"))
    ...
    while(finalizador <= rolete):
        ...
        time.sleep(1.5) #Espera 0.5 segundo para forjar o item

        #imagem = pyautogui.screenshot(r'testeSet.png')
        imagem = pyautogui.screenshot()
        areaAdds = pyautogui.locateOnScreen('C:\projetos\Roletar set\\invocacao2.png', confidence=.9);
